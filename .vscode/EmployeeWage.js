    ...
    empDailyHrsAndWageArr.push(
        {
            ...
            dailyHours:empHours,
            dailyWage:calculateWage(empHours),toString()
            {
...
let totalHrs = empDailyHrsAndWageArr.filter(dailyWageAndHrs => dailyWageAndHrs.dailyWage > 0)
                .reduce((totalHrs,dailyWageAndHrs) => totalHrs += dailyWageAndHrs.dailyHours,0)

let totalSalary = empDailyHrsAndWageArr.filter(dailyWageAndHrs => dailyWageAndHrs.dailyWage > 0)
                .reduce((totalSalary,dailyWageAndHrs) => totalSalary += dailyWageAndHrs.dailyWage,0)

console.log("Emp Wage using Arrow: Total Hours "+totalHrs + " Total Wage "+ totalSalary)

//Show day along daily wage
console.log("Daily Wage Map")
empDailyHrsAndWageArr.forEach(employee => console.log(`${employee.dayNum} : ${employee.dailyWage}`))

//Show days full time wage
...
//Find first occurence of full time wage
...
//Find number of days employee work
